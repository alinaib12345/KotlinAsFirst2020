...
fun russian(n: Int): String {
    ...
    val ten = listOf("десять", "двадцать", "тридцать", "сорок", "пятьдесят", "шестьдесят", "семьдесят",
    ...
    val wrongTeens = listOf("десять один", "десять два", "десять три", "десять четыре", "десять пять",
